            ...
            <div className="flex flex-col md:flex-row-reverse justify-between items-center md:items-start gap-16 text-right">
               ...
               <div className="space-y-10 flex flex-col items-center md:items-end">
                  ...
                  <div className="flex gap-5">
                     <a href="https://www.facebook.com/share/1Gcz3HbGFE/" target="_blank" rel="noopener noreferrer" className="w-16 h-16 rounded-[2rem] glass bg-white/5 flex items-center justify-center border border-white/5 hover:border-brand-green/40 hover:bg-brand-green/10 transition-all duration-700 group active:scale-90 shadow-lg">
                        <svg className="w-7 h-7 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                     </a>
                     <a href="https://www.instagram.com/shawarmanazoland?igsh=MTY5anA2MzY3bmh6Ng==" target="_blank" rel="noopener noreferrer" className="w-16 h-16 rounded-[2rem] glass bg-white/5 flex items-center justify-center border border-white/5 hover:border-brand-green/40 hover:bg-brand-green/10 transition-all duration-700 group active:scale-90 shadow-lg">
